...
interface IConstants {
    ...
    final String LOGIN_NOT_FOUND = "Login was not found";
    final String WRONG_PASSWD = "The password is incorrect";
    final String SUCCESS_AUTH = "Authorization completed";
    final String LOGIN_IN_USE ="Login is already taken";
}
